...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const checkout = await createGeniusPayCheckout({
      ...
      successUrl: `${process.env.VITE_APP_URL || 'https://emploi-concours.vercel.app'}/paiement/succes?kind=abonnement`,
      errorUrl: `${process.env.VITE_APP_URL || 'https://emploi-concours.vercel.app'}/paiement/echec?kind=abonnement`
    });
